...
$query ="SELECT DISTINCT `Меню_контента`.`Информация`, `Подразделы`.`Информация` FROM `Подразделы`, `Информация_контента`, `Меню_контента`, `Контент` where `Подразделы`.`idПодразделы` = `Информация_контента`.`Подраздел` and `Информация_контента`.`Контент_idКонтент` = `Контент`.`idКонтент`  and `Контент`.`Idменю` = `Меню_контента`.`idМеню_контента`
